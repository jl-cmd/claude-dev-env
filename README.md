...
| `build-goal` | Authors a paste-ready goal-mode prompt plus a human-readable brief from the current session's context and task list, then stops without implementing the goal's work |
