...
STDIN_PIPE_NAME: str = "stdin"

STDOUT_PIPE_NAME: str = "stdout"

STDERR_PIPE_NAME: str = "stderr"

TEXT_MODE_KEY: str = "text"

ENCODING_KEY: str = "encoding"

DECODE_ERRORS_KEY: str = "errors"

START_NEW_SESSION_KEY: str = "start_new_session"

CREATION_FLAGS_KEY: str = "creationflags"
