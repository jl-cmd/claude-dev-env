...
| `build_per_artifact_batch_constants.py` | `build_per_artifact_batch.py` - default out filename, `ROLE_NAME=PATH` split token, JSON indent, CLI flags, exit codes, stderr prefix, and re-exported shared worker defaults |
