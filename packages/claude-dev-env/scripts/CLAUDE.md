...
| `resolve_worker_spawn.py` | Dispatches a worker role through grok then claude fallback tiers (preflight, headless grok, `claude_agent_required` handoff, optional claude headless); protocol: [`../skills/_shared/pr-loop/worker-spawn.md`](../skills/_shared/pr-loop/worker-spawn.md) |
