...
| `post_claude_review_clean_comment.py` | Posts a deterministic PR issue comment after a clean claude-review pass (`## claude-review CLEAN`); soft-fail and idempotent per HEAD SHA |
