...
ARCHIVED_SKILLS_DIRECTORY_NAME: str = "skill-archive"

VENDORED_TREE_DIRECTORY_NAME: str = "vendor"

ALL_NON_RUNTIME_ROOT_DIRECTORY_NAMES: tuple[str, ...] = (
    ARCHIVED_SKILLS_DIRECTORY_NAME,
    VENDORED_TREE_DIRECTORY_NAME,
)
