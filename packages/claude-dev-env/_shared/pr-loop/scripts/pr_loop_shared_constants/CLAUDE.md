...
| `code_rules_gate_constants.py` | `code_rules_gate.py`, staged attestation, and staged pytest helpers — file extensions, Git snapshot/worktree commands, unborn-HEAD identity, test patterns, provenance controls, and attestation schema fields |
