...
CODEX_SOL_MODEL_ID: str = "gpt-5.6-sol"
...
FABLE_MODEL_TIER: str = "Fable"
CODEX_RESULT: str = "codex"
FABLE_RESULT: str = "fable"
...
ALL_SOL_GUIDANCE_SIGNALS: frozenset[str] = frozenset(
