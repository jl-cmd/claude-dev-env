...
Groups: the PreToolUse envelope keys and values, the tool-input keys, the
hook decision keys and the block-decision values, the join separators, the
destructive and personal-data probe payload values, the probe hook timeout,
and the exit codes.
"""
...
ENVELOPE_SESSION_ID_VALUE = "probe"
ENVELOPE_HOOK_EVENT_NAME_KEY = "hook_event_name"
ENVELOPE_HOOK_EVENT_NAME_VALUE = "PreToolUse"
...
ALL_BLOCK_DECISION_VALUES = ("deny", "ask")
