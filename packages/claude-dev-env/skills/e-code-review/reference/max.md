# max effort — full review procedure
...
This is recall mode — a single non-REFUTED vote carries the finding. Do NOT discard candidates on uncertainty.
...
- **Nits only:** every finding is a nit. Fix all nits, run the required checks, push the fixes, and run another max review. Repeat this outcome until a review is clean, then mark the change ready.
