...
UNRESOLVABLE_ROUTE_MODEL = "UNRESOLVABLE_ROUTE_MODEL"
ALL_MODEL_TIER_ALIASES = ("fable", "opus", "sonnet", "haiku")
ALL_SPAWN_MODEL_TOKENS = (
    *ALL_MODEL_TIER_ALIASES,
    *(f"{each_alias}-equivalent" for each_alias in ALL_MODEL_TIER_ALIASES),
)
