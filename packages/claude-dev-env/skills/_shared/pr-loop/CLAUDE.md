...
Runtime documents and scripts shared by every PR-loop skill. Changes here affect bugteam, pr-converge, findbugs, fixbugs, qbug, and autoconverge simultaneously — treat this as a breaking-change surface.
...
| scripts/ | Python scripts for gates, permissions, loop state, prompt building, outcomes, path resolution, pacer choice, and preflight |
