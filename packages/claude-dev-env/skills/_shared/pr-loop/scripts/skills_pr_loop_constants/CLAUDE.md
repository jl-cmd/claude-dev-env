...
| `portable_driver_constants.py` | Phase names, next-action tokens, wait delays, blockers, CLI flags, clean-comment script path flags, and result keys for `portable_converge_driver.py`. |
