...
<example> CODE_REVIEW tick, static sweep clean, `/code-review ultra --fix`
...
<example> CODE_REVIEW tick, static sweep clean and `/code-review ultra --fix`
...
sweep and `/code-review ultra --fix` both pass, sets `code_review_clean_at =
HEAD`, `phase = BUGTEAM`]
</example>
