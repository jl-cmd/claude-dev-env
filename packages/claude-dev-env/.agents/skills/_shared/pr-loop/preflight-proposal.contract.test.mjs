...
const sharedSkillSource = readFileSync(
  resolve(THIS_DIRECTORY, '../../shared-extraction-audit/SKILL.md'),
  'utf8',
)
const capabilitySkillSource = readFileSync(
  resolve(THIS_DIRECTORY, '../../name-by-capability-audit/SKILL.md'),
  'utf8',
)
...
const allSkillContracts = [
  {
    ...
    invocationPattern: /shared-extraction-audit preflight-proposal/,
  ...
  },
  {
    ...
    invocationPattern: /name-by-capability-audit preflight-proposal/,
