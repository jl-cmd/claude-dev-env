...
CONFIG_DIR_OVERRIDE_ENVIRONMENT_KEY = "CLAUDE_CONFIG_DIR"
DEFAULT_MANAGED_ROOT_DIRECTORY_NAME = ".claude"
ALL_DURABLE_POST_LINTER_RELATIVE_PATH_PARTS = ("scripts", "durable_post_lint.py")
