---
name: "source-command-stubcheck"
description: "Detect and fix stub implementations in code and plans with agent/skill recommendations"
---

# source-command-stubcheck

Use this skill when the user asks to run the migrated source command `stubcheck`.
...
**General stubs →**
- Follow TDD workflow from AGENTS.md
