...
PACKAGE_ROOT = SKILL_DIRECTORY.parent.parent.parent
SKILL_PATH = SKILL_DIRECTORY / "SKILL.md"
PLAN_COMMAND_PATH = PACKAGE_ROOT / "commands" / "plan.md"
SR_LOOP_COMMAND_PATH = PACKAGE_ROOT / "commands" / "sr-loop.md"
VALIDATOR_AGENT_PATH = PACKAGE_ROOT / ".agents" / "agents" / "plan-packet-validator.md"
