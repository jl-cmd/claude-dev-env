---
name: "source-command-docupdate"
description: "Scan and update all documentation (.md files, skills, agents) for the current project"
---

# source-command-docupdate

Use this skill when the user asks to run the migrated source command `docupdate`.
...
**Priority order:**
1. `.Codex/skills/` - Project skills (most impactful)
2. `.Codex/AGENTS.md` - Project instructions
3. `scripts/*/README.md` - Module READMEs
4. `README.md` - Project overview
5. `.Codex/agents/` - Project agents
...
**Create skill in:** `.Codex/skills/<skill-name>/SKILL.md`
...
- ~/.Codex/skills/X - Not affected by project work
```
...
- `~/.Codex/skills/X` - [why not touched]
```
...
- If no .Codex directory exists, create it
