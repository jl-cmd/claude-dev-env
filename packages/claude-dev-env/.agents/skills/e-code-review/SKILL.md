...
The proposal contract lives in [reference/preflight-proposal.md](reference/preflight-proposal.md). It selects the review level and records finding outcomes. The downstream owner records selected proposal IDs before reapplication; each new finding receives a new ID.
