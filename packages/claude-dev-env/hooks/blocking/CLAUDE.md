...
| `pii_prevention_blocker.py` | PreToolUse (Write/Edit/MultiEdit/Bash/MCP GitHub) | Content that carries high-confidence personal data or secrets (real emails, home-dir paths, private IPs, credential material) on write, durable GitHub posts, or staged commit paths |
