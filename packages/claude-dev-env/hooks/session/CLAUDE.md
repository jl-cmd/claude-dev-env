...
| `session_edit_tracker_cleanup.py` | SessionStart | Deletes the current session's session edit tracker file and prunes stale tracker files left by crashed sessions from the system temp directory |
