...
def test_unused_import_guidance_uses_comment_free_side_effect_remediation() -> None:
    assert "noqa" not in UNUSED_IMPORT_GUIDANCE
    assert "importlib.import_module" in UNUSED_IMPORT_GUIDANCE
