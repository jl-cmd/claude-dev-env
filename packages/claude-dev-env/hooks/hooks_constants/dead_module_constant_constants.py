...
DEAD_MODULE_CONSTANT_GUIDANCE: str = (
    "The module-level constant needs a consumer in the enclosing package tree. "
    "Reference it where its value is needed or remove it (CODE_RULES §9.8)."
)
DEAD_MODULE_CONSTANT_RETRY_GUIDANCE: str = (
    "Write the consumer first, then write the constant; re-issue this write after "
    "the consumer is on disk; the post-write check accepts both names."
)
