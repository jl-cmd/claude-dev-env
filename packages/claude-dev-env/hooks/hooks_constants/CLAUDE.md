...
| `prose_style_enforcement_constants.py` | The shared `PROSE_STYLE_ENFORCEMENT_ENABLED` switch (default off) that the five prose-style hooks read before they block, plus the roster of those hook modules |
