...
| `comment_path_reference_blocker_constants.py` | Tool-name set, CI-workflow file recognizers, comment-line and path-token patterns, base-directory recognizer, scan budgets, and block-message text for the comment path-reference blocker |
