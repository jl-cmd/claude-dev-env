...
| `pr_description_numeric_claims_constants.py` | Claim-detection patterns, test-file glob, git base-revision command tokens, and mismatch-message templates for the PR-body numeric-claim accuracy check |
