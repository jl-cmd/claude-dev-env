...
This rule extends the `constants-location` rule defined in `~/.claude/docs/CODE_RULES.md` — see the ⚡ LINT-ENFORCED RULES section, the "UPPER_SNAKE constants only in `config/`" clause.
