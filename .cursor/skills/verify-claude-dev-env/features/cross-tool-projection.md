...
Run `node .cursor/skills/verify-claude-dev-env/scripts/driver.mjs`. Run `python -m pytest packages/claude-dev-env/scripts/tests/test_codex_compat_materializer.py -q` for Codex.
