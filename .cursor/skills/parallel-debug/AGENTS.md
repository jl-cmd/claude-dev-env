...
The `parallel-debug` Cursor skill. Drives the pr-converge convergence loop across all open PRs in `jl-cmd/claude-dev-env`, paced by an AutoHotkey auto-typer.
