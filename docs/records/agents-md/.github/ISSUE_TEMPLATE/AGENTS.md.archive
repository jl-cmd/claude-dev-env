...
| `bug-report.yml` | Bug Report | Structured form for bugs in `claude-dev-env` or `claude-dev-env` — collects description, reproduction steps, expected behavior, and environment |
